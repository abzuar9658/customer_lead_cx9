...
const Home = () => {
        ...
        return ( <
            ...
            <
            Grid.Row className = { classes.homeBody }
            style = {
                { minHeight: "83.6vh", padding: "3.5em" } } >
            <
            Container >
            <
            ...
            />{" "} <
            Form.Input fluid label = "Company Email"
            placeholder = "email"
            value = { email }
            onChange = {
                (e) => setemail(e.target.value) }
            />{" "} <
            Form.Input fluid label = "Company Phone"
            placeholder = "phone"
            value = { phone }
            onChange = {
                (e) => setphone(e.target.value) }
            />{" "} <
            Form.Input fluid label = "Company Weblink"
            placeholder = "weblink"
            value = { weblink }
            onChange = {
                (e) => setweblink(e.target.value) }
            />{" "} <
            /Form.Group>{" "} <
