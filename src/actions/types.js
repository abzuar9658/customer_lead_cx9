...
export const LEADS_LOADING_COMPANY = "LEADS_LOADING_COMPANY";
export const LEADS_LOAD_COMPANY_SUCCESS = "LEADS_LOAD_COMPANY";
export const LEADS_LOAD_COMPANY_FAIL = "LEADS_LOAD_COMPANY";
